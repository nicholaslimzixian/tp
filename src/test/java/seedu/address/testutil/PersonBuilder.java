...
public class PersonBuilder {
     ...
     */
    public PersonBuilder withFaculties(String... faculties) {
        this.faculties = SampleDataUtil.getFacultySet(faculties);
        return this;
    }
    ...
    public Person build() {
        return new Person(name, phone, email, address, tags, faculties, favorite);
    }
